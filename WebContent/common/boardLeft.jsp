...
<div class="col-3">
	...
	<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		...
		<a class="nav-link" id="v-pills-profile-tab" href="javascript:alert('준비중임');" role="tab" aria-controls="v-pills-profile" aria-selected="false">자료실</a>
		<a class="nav-link" id="v-pills-messages-tab" href="javascript:alert('준비중임');" role="tab" aria-controls="v-pills-messages" aria-selected="false">방명록</a>				
